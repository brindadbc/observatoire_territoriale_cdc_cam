...

{
    ...
    public function create()
    {
        ...
        $receveurs = Receveur::whereNull('commune_id')->where('est_actif', true)->orderBy('nom')->get();
        $ordonnateurs = Ordonnateur::whereNull('commune_id')->where('est_actif', true)->orderBy('nom')->get();
