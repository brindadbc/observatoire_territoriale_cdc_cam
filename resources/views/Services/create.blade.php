...
@section('title', 'Ajouter un Service Social')

@section('content')
<div class="service-form-container">
    <div class="form-header">
        <h1><i class="fas fa-plus-circle"></i> Ajouter un Nouveau Service Social</h1>
        ...
        <div class="form-card">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @error('schedule') is-invalid @enderror" 
                          id="schedule" name="schedule" rows="2">{{ old('schedule') }}</textarea>
                @error('schedule')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        $('#openMapModal').click(function() {
            ...
            if (typeof map === 'undefined') {
                const defaultLat = {{ $commune->latitude ?? 14.764504 }};
                const defaultLng = {{ $commune->longitude ?? -17.366029 }};
                ...
                if (existingLat && existingLng) {
                    ...
                    $('#modalLatitude').val(existingLat);
                    $('#modalLongitude').val(existingLng);
                }
            }
        });
