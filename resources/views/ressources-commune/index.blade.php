...
<head>
    ...
    <title>Ressources des Communes - Gestion Communale</title>
    ...
    <header class="header">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h1><i class="bi bi-cash-stack me-2"></i>Ressources Générées par les Communes</h1>
                </div>
                {{-- <div class="col-md-6 text-end">
                    <a href="{{ route('dashboard') }}" class="btn btn-outline-light me-2">
                        <i class="bi bi-speedometer2"></i> Dashboard
                    </a> --}}
                    <a href="{{ route('ressources-commune.create') }}" class="btn btn-light">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <div class="stats-card">
                   ...
                   <h3>{{ isset($totalRessources) ? number_format($totalRessources, 0, ',', ' ') . ' FCFA' : 'N/A' }}</h3>
                </div>
            </div>
            <div class="col-md-4">
                <div class="stats-card">
                    ...
                    <table class="table table-hover" id="ressourcesTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $ressource->date_generation->format('d/m/Y') }}</td>
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('ressources-commune.show', $ressource) }}" class="btn btn-info btn-sm" title="Voir">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="{{ route('ressources-commune.edit', $ressource) }}" class="btn btn-warning btn-sm" title="Modifier">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <form action="{{ route('ressources-commune.destroy', $ressource) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
